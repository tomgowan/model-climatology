...
links = ["/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/snotel_precip_2016_2017_qc.csv", 
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/ncarens5_precip_12Zto12Z_interp.txt",
         "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/snotel_data/2016_17_cool_season/ncarens5_precip_12Zto12Z_interp.txt"]
...
#csAVG = map.scatter(xi,yi, marker='o',  c = 'blue',s = 150, vmin = 0.4, vmax = 2.2, label = "Pacific Ranges (124 sites)")
#csAVG2 = map.scatter(xii,yii,  marker='o', c = 'red', s = 150, vmin = 0.4, vmax = 2.2, label = "Interior Ranges (427 sites)")
...
#plt.savefig("../../../public_html/snotel_regions.png")    
#plt.show()

######################### Edited version for defense (above version is for regions ################                                           
fig = plt.figure(figsize=(14,12))
#plt.title('SNOTEL Regions', fontsize = 28)
ax = fig.add_subplot(111)
map = Basemap(projection='merc',llcrnrlon=latlon[0],llcrnrlat=latlon[1],urcrnrlon=latlon[2],urcrnrlat=latlon[3],resolution='i')
...
matplotlib.rcParams.update({'font.size': 42})
#csAVG = map.scatter(xi,yi, marker='o',  c = 'blue',s = 150, vmin = 0.4, vmax = 2.2)#, label = "Pacific Ranges (124 sites)")
#csAVG2 = map.scatter(xii,yii,  marker='o', c = 'blue', s = 150, vmin = 0.4, vmax = 2.2)#, label = "Interior Ranges (427 sites)")
#csAVG = map.scatter(x,y, marker='o',  c = 'blue',alpha = 1, s = 150, vmin = 0.4, vmax = 2.2)#, label = "Not Included")
#csAVG = map.scatter(xi,yi, marker='o',  c = 'blue',s = 150, vmin = 0.4, vmax = 2.2)
#csAVG2 = map.scatter(xii,yii,  marker='o', c = 'blue', s = 150, vmin = 0.4, vmax = 2.2)
map.drawcoastlines() 
map.drawstates()
map.drawcountries()
plt.tight_layout()
