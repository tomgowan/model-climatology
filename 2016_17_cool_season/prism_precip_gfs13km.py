...
for i in range(0,days): 
    ...
    gfs_file = "/uufs/chpc.utah.edu/common/home/steenburgh-group5/tom/model_prism_interp/2016_17_cool_season/gfs13km/%08d" % Date[i] + "gfs13km_prism_interp.nc"
    ...
    if x == 1 and z == 1:
        ...
        try:
            precipI = fh.variables['var59'][:,:]   ########### make work for way gfs data in in their and remeber to correct for weird units
        except:
            precipI = fh.variables['PRATE_GDS4_SFC_ave6h'][:,:] ### For files that I had to convert to netcdf then interpolate
        precipI_sum = sum(precipI, axis = 0)*60*60*6
        totalprecip = totalprecip + precipI_sum
...
np.savetxt('gfs_dailymean.txt', totalprecip)
...
plt.savefig("../../../public_html/gfs_prism_climo_2016_17.png")
plt.show()
