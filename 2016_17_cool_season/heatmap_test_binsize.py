...
for i in range(6):
    ...
    if i == 0 or i == 2:
        ax1.set_yticklabels(xlab, fontsize = 13)
    ...
    if i == 5:
        ax1.set_xticklabels(xlab, fontsize  = 13, rotation = 45)
    ...
    heatmap = ax1.pcolor(g, vmin=0.00005, vmax=.1, cmap=discrete_cmap(13, 'jet'), norm=matplotlib.colors.LogNorm())
...
ticks = np.logspace(1, 0.232503, num = 13, base = 0.00005)
cbar = plt.colorbar(heatmap, ax = ax2,ticks = ticks,format = formatter)
cbar.ax.set_yticklabels(['0.00005', '0.00009', '0.0002', '0.0003','0.0006','0.001','0.002','0.004','0.008','0.015','0.03','0.05','0.1'], fontsize = 13)

cbar.ax.set_xlabel('\nFrequency', fontsize  = 14)
plt.savefig("../../../public_html/heatmaps_2016_17.pdf", bbox_inches='tight')
plt.show()
