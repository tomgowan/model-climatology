...
for i in range(0,80):
   ...
   bias[i,4] = frequency[i,5]/frequency[i,0] #gfs
...
plt.ylim([.03,60])
#ax1.set_yscale('log')
linecolor = ['k','blue', 'green', 'red', 'c', 'gold']
...
plt.legend(handles=[black, blue, green, red, cyan, gold], fontsize = 14)
