...
levels_el = np.arange(1000,3501,100)
cmap = plt.cm.BrBG
...
plt.text(x[3], y[3], 'Stansbury Mtns', fontsize = label, rotation = -85)
plt.text(x[4], y[4], 'Oquirrh Mtns', fontsize = label, rotation = -85)
plt.text(x[5], y[5], 'Wasatch\nRange', fontsize = label, rotation = 0)
...
cbar = plt.colorbar(csAVG2, ax = ax3, ticks= np.arange(1000,3501,500),orientation='horizontal')
cbar.ax.set_xlabel('Elevation (m)', fontsize  = axis_title, labelpad = 18)  
cbar.ax.set_xticklabels(np.arange(1000,3501,500), fontsize = label+2) 
