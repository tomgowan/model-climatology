...
levels_el = np.arange(0,4800,100)
cmap = plt.cm.BrBG
...
plt.annotate('Mean = %1.3f\n' % snotel_mean_ncar  +
             'SD = %1.3f' % snotel_stdev_ncar, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
#cbar.ax.set_xticklabels(['<0.5','0.6',  '0.8',  '1',  '1.4',  '1.8','>2'], fontsize = label) 
plt.annotate('Mean = %1.3f\n' % snotel_mean_gfs  +
             'SD = %1.3f' % snotel_stdev_gfs, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
#cbar.ax.set_xticklabels(['<0.5','0.6',  '0.8',  '1',  '1.4',  '1.8','>2'], fontsize = label) 
plt.annotate('Mean = %1.3f\n' % snotel_mean_hrrr  +
             'SD = %1.3f' % snotel_stdev_hrrr, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
#cbar.ax.set_xticklabels(['<0.5','0.6',  '0.8',  '1',  '1.4',  '1.8','>2'], fontsize = label) 
plt.annotate('Mean = %1.3f\n' % snotel_mean_nam  +
             'SD = %1.3f' % snotel_stdev_nam, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
plt.annotate('Mean = %1.3f\n' % snotel_mean_sref_arw  +
             'SD = %1.3f' % snotel_stdev_sref_arw, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
plt.annotate('Mean = %1.3f\n' % snotel_mean_sref_nmb  +
             'SD = %1.3f' % snotel_stdev_sref_nmb, xy=(0.03, .039),
             xycoords='axes fraction', fontsize = info, backgroundcolor = 'w', bbox = props)
...
plt.savefig("../../../public_html/bias_snotel_allmodels_interp_2016_17.png")
plt.show()
